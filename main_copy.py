...
def printme():
    print(collect_data(response))

def prometheus_gg(num):
    registry = CollectorRegistry()
    g = Gauge("gg_daily", "Google Analytics Daily", registry=registry)
    g.set(num)
    return registry
